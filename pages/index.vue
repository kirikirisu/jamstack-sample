  ...
  <div>
    ...
    >
      <div class="absolute top-0 w-full h-full bg-center bg-cover visual-home">
        <span id="blackOverlay" class="w-full h-full absolute opacity-75">
        </span>
      </div>
      <div class="container relative mx-auto">
        <div class="items-center flex flex-wrap">
          <div class="w-full lg:w-6/12 px-4 md-auto mr-auto text-center">
            <div>
    ...
    <div class="w-full md:max-w-3xl mx-auto pt-20 px-6 md:px-0">
      ...
      <div class="flex flex-wrap justify-between mb-20 md:mb-0">
        <div class="md:w-56 mb-20 shadow-lg bg-gray-200">
          <div class="max-w">
            <img src="~/assets/img/menu01.jpg" alt="menu name" class="w-full" />
            <div class="px-6 py-4">
              <div class="font-bold text-xl mb-2">American Coffe</div>
              <p class="text-gray-700 text-base mb-4">480円</p>
            </div>
          </div>
        </div>
        <div class="md:w-56 mb-20 shadow-lg bg-gray-200">
      ...
      >
        <a href="/information/detail" class="block px-4 py-3">
          <time class="text-gray-700 text-base mb-1 block md:w-1/6"
            >2021.01.20</time
          >
          <div class="md:w-10/12">お知らせ１</div>
        </a>
      </div>
      <div
        class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 shadow-md mb-5"
      >
        <a href="/information/detail" class="block px-4 py-3">
          <time class="text-gray-700 text-base mb-1 block md:w-1/6"
            >2021.01.20</time
          >
          <div class="md:w-10/12">お知らせ2</div>
        </a>
      </div>
      <div
        class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 shadow-md mb-5"
      >
        <a href="/information/detail" class="block px-4 py-3">
          <time class="text-gray-700 text-base mb-1 block md:w-1/6"
            >2021.01.20</time
          >
          <div class="md:w-10/12">お知らせ3</div>
        </a>
      </div>
    </div>
    <div class="mb-10 mx-auto text-center">
      <a
        href="/information/"
        class="font-seminbold md:text-lg xl:text-base px-4 md:px-5 xl:px-4 py-3 md:py-4 xl:py-3 leading-tight shadow-md rounded-lg bg-white hover:bg-gray-200 text-gray-800"
      >
        お知らせ一覧
      </a>
    </div>
    <footer class="bg-black pb-10 pt-10">
      ...
      >
        Copyright ©︎ 2021 nuxt sample site demo
      </p>
    </footer>
  </div>
</template>
